...
class agate extends PaymentModule {
    ...
    public function install() {
      ...
      if(!function_exists('curl_version')) {
        ...
        if($result==$check){
          ...
          $order_invalid->name = array_fill(0, 10, 'Agate invoice is invalid');
          ...
          Configuration::updateValue('AGATE_INVALID', $order_invalid->id);
      }
    ...
    public function execPayment($cart) {
      ...
      error_log("Base Uri : ".$baseUri." API KEY : ".$api_key." CallbackUri : ".$redirect_url);
